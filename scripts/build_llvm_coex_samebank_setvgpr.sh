...
LLVM_BUILD_DIR="$LLVM_SRC_DIR/build-coexec-samebank-setvgpr"
LLVM_INSTALL_DIR="${LLVM_INSTALL_DIR:-$LLVM_SRC_DIR/mlir_install_coexec_samebank_setvgpr}"
LLVM_INSTALL_TGZ="${LLVM_INSTALL_TGZ:-$LLVM_SRC_DIR/mlir_install_coexec_samebank_setvgpr.tgz}"
...
LLVM_BRANCH="${LLVM_BRANCH:-amd/dev/jli/set-bank-id}"
