...
LLVM_BUILD_DIR="$LLVM_SRC_DIR/build-coexec-samebank2"
LLVM_INSTALL_DIR="${LLVM_INSTALL_DIR:-$LLVM_SRC_DIR/mlir_install_coexec_samebank2}"
LLVM_INSTALL_TGZ="${LLVM_INSTALL_TGZ:-$LLVM_SRC_DIR/mlir_install_coexec_samebank2.tgz}"
...
LLVM_BRANCH="${LLVM_BRANCH:-amd/dev/jli/coexec-samebank}"
