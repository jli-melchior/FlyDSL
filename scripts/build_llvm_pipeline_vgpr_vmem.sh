...
LLVM_BUILD_DIR="$LLVM_SRC_DIR/build-vgpr-vmem-flydsl"
LLVM_INSTALL_DIR="${LLVM_INSTALL_DIR:-$LLVM_SRC_DIR/mlir_install_vgpr_vmem}"
LLVM_INSTALL_TGZ="${LLVM_INSTALL_TGZ:-$LLVM_SRC_DIR/mlir_install_vgpr_vmem.tgz}"
